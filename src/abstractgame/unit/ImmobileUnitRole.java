...
/**
 * The Class ImmobileUnitRole.
 *
 * @author Nils Kuttkat
 */
public final class ImmobileUnitRole extends AbstractMobilityRole {
    ...
    public static AbstractMobilityRole GetRole() {
        if (AbstractMobilityRole.INSTANCE == null) {
            AbstractMobilityRole.INSTANCE = new ImmobileUnitRole();
        }
	...
	/**
	 * Instantiates a new immobile unit role.
	 */
	private ImmobileUnitRole() {
    }
